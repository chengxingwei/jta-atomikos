...
//        BeanUtils.copyProperties(firstDataSourceProperties, druidXADataSource);
        ...
        DruidXADataSource druidXADataSource = new DruidXADataSource();
        druidXADataSource.setUrl(firstDataSourceProperties.getUrl());
        druidXADataSource.setUsername(firstDataSourceProperties.getUsername());
        druidXADataSource.setPassword(firstDataSourceProperties.getPassword());
