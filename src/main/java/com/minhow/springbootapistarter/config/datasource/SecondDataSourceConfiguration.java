...
//        BeanUtils.copyProperties(secondDataSourceProperties, druidXADataSource);
        ...
        DruidXADataSource druidXADataSource = new DruidXADataSource();
        druidXADataSource.setUrl(secondDataSourceProperties.getUrl());
        druidXADataSource.setUsername(secondDataSourceProperties.getUsername());
        druidXADataSource.setPassword(secondDataSourceProperties.getPassword());
